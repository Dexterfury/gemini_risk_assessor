    ...
    try {
      ...
      for (const uid of awaitingApprovalUIDs) {
        ...
        try {
          ...
          error(`Error processing user ${uid}:`, userError);
        }
      }
      ...
      error(`Error in onCreateOrganization for ${context.params.orgId}:`, e);
  ...
  exports.onUpdateOrganization = functions.firestore
    ...
    .onUpdate(async (change, context) => {
      try {
        ...
        error(`Error in onUpdateOrganization for ${context.params.orgId}:`, e);
        throw e;
      }
    });